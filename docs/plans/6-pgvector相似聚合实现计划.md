...
purpose: "将 `pgvector相似聚合` PRD 拆成可执行任务、验证命令和回滚边界。"
canonical_path: "docs/plans/6-pgvector相似聚合实现计划.md"
status: approved
version: "1.0.0"
owner: "StephenQiu30"
inputs:
...
outputs:
  ...
  - pgvector相似聚合验证证据
triggers:
  - "docs/product/prd/6-pgvector相似聚合PRD.md 变更"
...
- PRD：`docs/product/prd/6-pgvector相似聚合PRD.md`
- Plan：`docs/plans/6-pgvector相似聚合实现计划.md`
