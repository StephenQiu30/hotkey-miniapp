...
canonical_path: "docs/plans/14-多租户与组织空间实现计划.md"
status: approved
version: "1.0.0"
owner: "StephenQiu30"
inputs:
  - docs/product/prd/14-多租户与组织空间PRD.md
  - docs/engineering/1-Go后端重建与开源仓库治理设计.md
outputs:
  - 多租户与组织空间实现任务
  - 多租户与组织空间验证证据
triggers:
  - "docs/product/prd/14-多租户与组织空间PRD.md 变更"
...
- PRD：`docs/product/prd/14-多租户与组织空间PRD.md`
- Plan：`docs/plans/14-多租户与组织空间实现计划.md`
