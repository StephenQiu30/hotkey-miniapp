...
canonical_path: "docs/plans/21-复杂RBAC与审计日志实现计划.md"
status: approved
version: "1.0.0"
owner: "StephenQiu30"
inputs:
  - docs/product/prd/21-复杂RBAC与审计日志PRD.md
  - docs/engineering/1-Go后端重建与开源仓库治理设计.md
outputs:
  - 复杂RBAC与审计日志实现任务
  - 复杂RBAC与审计日志验证证据
triggers:
  - "docs/product/prd/21-复杂RBAC与审计日志PRD.md 变更"
...
- PRD：`docs/product/prd/21-复杂RBAC与审计日志PRD.md`
- Plan：`docs/plans/21-复杂RBAC与审计日志实现计划.md`
