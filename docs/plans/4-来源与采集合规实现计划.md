...
purpose: "将 `来源与采集合规` PRD 拆成可执行任务、验证命令和回滚边界。"
canonical_path: "docs/plans/4-来源与采集合规实现计划.md"
status: approved
version: "1.0.0"
owner: "StephenQiu30"
inputs:
...
outputs:
  ...
  - 来源与采集合规验证证据
triggers:
  - "docs/product/prd/4-来源与采集合规PRD.md 变更"
...
实现事实层与传播层来源配置、采集适配器接口和合规接入边界。

## 2. 文件清单

- PRD：`docs/product/prd/4-来源与采集合规PRD.md`
- Plan：`docs/plans/4-来源与采集合规实现计划.md`
