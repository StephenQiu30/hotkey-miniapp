...
purpose: "将 `多租户与组织空间` PRD 拆成可执行任务、验证命令和回滚边界。"
canonical_path: "docs/plans/20-多租户与组织空间实现计划.md"
status: approved
version: "1.0.0"
owner: "StephenQiu30"
inputs:
  - docs/product/prd/20-多租户与组织空间PRD.md
  - docs/engineering/1-Go后端重建与开源仓库治理设计.md
outputs:
  - 多租户与组织空间实现任务
  - 多租户与组织空间验证证据
triggers:
  - "docs/product/prd/20-多租户与组织空间PRD.md 变更"
...
- PRD：`docs/product/prd/20-多租户与组织空间PRD.md`
- Plan：`docs/plans/20-多租户与组织空间实现计划.md`
