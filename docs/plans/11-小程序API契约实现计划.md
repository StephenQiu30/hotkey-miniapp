...
purpose: "将 `小程序API契约` PRD 拆成可执行任务、验证命令和回滚边界。"
canonical_path: "docs/plans/11-小程序API契约实现计划.md"
status: approved
version: "1.0.0"
owner: "StephenQiu30"
inputs:
...
outputs:
  ...
  - 小程序API契约验证证据
triggers:
  - "docs/product/prd/11-小程序API契约PRD.md 变更"
...
定义并实现小程序端所需热点、事件、关键词、日报和刷新 API。

## 2. 文件清单

- PRD：`docs/product/prd/11-小程序API契约PRD.md`
- Plan：`docs/plans/11-小程序API契约实现计划.md`
