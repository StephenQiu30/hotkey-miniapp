...
purpose: "将 `热点排序与详情API` PRD 拆成可执行任务、验证命令和回滚边界。"
canonical_path: "docs/plans/8-热点排序与详情API实现计划.md"
status: approved
version: "1.0.0"
owner: "StephenQiu30"
inputs:
...
outputs:
  ...
  - 热点排序与详情API验证证据
triggers:
  - "docs/product/prd/8-热点排序与详情APIPRD.md 变更"
...
- PRD：`docs/product/prd/8-热点排序与详情APIPRD.md`
- Plan：`docs/plans/8-热点排序与详情API实现计划.md`
