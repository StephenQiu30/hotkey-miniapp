...
purpose: "将 `产品总览与阶段路线` PRD 拆成可执行任务、验证命令和回滚边界。"
canonical_path: "docs/plans/1-产品总览与阶段路线计划.md"
status: approved
version: "1.0.0"
owner: "StephenQiu30"
inputs:
  - docs/product/prd/1-产品总览与阶段路线PRD.md
  - docs/engineering/1-Go后端重建与开源仓库治理设计.md
outputs:
  - 产品总览与阶段路线实现任务
  - 产品总览与阶段路线验证证据
triggers:
  - "docs/product/prd/1-产品总览与阶段路线PRD.md 变更"
...
定义 Go 后端全面重构后的产品总览、阶段路线、旧文档清理边界和从 1 开始的新编号体系。

## 2. 文件清单

- PRD：`docs/product/prd/1-产品总览与阶段路线PRD.md`
- Plan：`docs/plans/1-产品总览与阶段路线计划.md`
